...
void ShowUsage() {		//a function to show the user how to use the program.
	...
	cout << "To check your player level(Newbie, Beginner, Expert, Champion)  press 'L'" << endl;
...
{	//delaring varibles
	...
	cout << setw(48) << setfill('*') << right << "Fire Edition!" << left << setw(32) << setfill('*') << "" << endl;
	...
	cout << "5. Use a fire token to instantly win the game." << endl;
...
/////////////////////////////////////////////////////
//Data for file read in function
/////////////////////////////////////////////////////
/*
Sarah 275 85
Micheal 234 5
